        ...
        public class PatrolState : FSMAIState
        {
            ...
            public override Transition[] OnGetTransitions()
            {
                return new Transition[]
                {
                    ...
                    && (SeesPlayer() || InDistance(State.VeryClosePlayerDetection, PlayerPosition) || HearsPlayerOrAlerted()) && !IsPlayerDead)
                };
            }
            ...
            public override void OnStateEnter()
            {
                ...
                // Переключить оружие в режим idle/walk/run при патрулировании
