...
namespace UHFPS.Runtime
{
    ...
    public class NPCStateMachine : MonoBehaviour
    {
        ...
        [Tooltip("NPC Perception System for hearing and damage detection")]
        public NPCPerceptionSystem PerceptionSystem;

        private NPCPerceptionSystem m_PerceptionSystem;
        public NPCPerceptionSystem PerceptionSystemInstance
        {
            get
            {
                if (m_PerceptionSystem == null)
                    m_PerceptionSystem = PerceptionSystem != null ? PerceptionSystem : GetComponent<NPCPerceptionSystem>();
                return m_PerceptionSystem;
            }
        }
