    ...
    public class ZombieChaseState : AIStateAsset
    {
        ...
        public class ChaseState : FSMAIState
        {
            ...
            public override Transition[] OnGetTransitions()
            {
                ...
                {
                    Transition.To<ZombiePatrolState>(() => (waitTime > State.LostPlayerPatrolTime || playerDied) && !HearsPlayerOrAlerted()),
            ...
            public override void OnStateEnter()
            {
                ...
                // Переключить оружие на атакующий сокет при преследовании
                weaponHandler?.SwitchToAttack();
            }
            ...
            public override void OnStateExit()
            {
                ...
                // Вернуть оружие в состояние idle/walk/run при выходе из преследования
                weaponHandler?.SwitchToIdleWalkRun();
            }
            ...
            private bool PlayerInSights()
            {
                ...
                // Check if alerted by damage or hears player
                if (HearsPlayerOrAlerted())
                    return true;
