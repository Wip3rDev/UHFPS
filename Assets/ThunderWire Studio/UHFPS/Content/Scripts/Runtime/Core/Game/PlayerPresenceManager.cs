...
namespace UHFPS.Runtime
{
    ...
    public class PlayerPresenceManager : Singleton<PlayerPresenceManager>
    {
        ...
        /// <summary>
        /// Event triggered when player fires a gun shot.
        /// Parameter: shoot position (muzzle position).
        /// </summary>
        public static Action<Vector3> OnPlayerShot;
        ...
        {
            // Only subscribe to OnGameLoaded if SaveGameManager is available
